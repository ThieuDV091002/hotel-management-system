...
import { Role } from "../../context/Role"; // Import Role type
...
export default function UserInfoCard({ userData, updateUserData }: UserInfoCardProps) {
  ...
  const handleSave = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Update parent component's userData state, preserving role
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{userData.fullName}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{userData.phoneNumber}</p>
            </div>
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Salary</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{userData.salary} VND/Month</p>
            </div>
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Hire date</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{userData.hireDate}</p>
            </div>
          </div>
        </div>
        <button
